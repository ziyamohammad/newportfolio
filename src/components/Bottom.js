...
const Bottom = ({handleclick}) => {
  const[active,setActive]=useState('beginning')
  return (
    
    <div className={styles.bottomTabs}>
        <div className={styles.box}  style={{ borderLeftColor: active === "beginning" ? "rgba(232, 74, 74, 1)" : "rgba(36, 36, 37, 1)" }} onClick={()=>{
          setActive('beginning')
          handleclick('beginning')}}>
